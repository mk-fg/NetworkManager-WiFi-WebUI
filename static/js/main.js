...
(function() {
  var ap_list, ap_list_empty, ap_tpl, assert, conn_action, conn_box, conn_config, conn_mode, conn_mode_lock, conn_status, data_node, sb_log;
    ...
    sock_onmessage = function(e) {
      ...
      if (data.q === 'new' || data.q === 'update') {
        ...
        ap_btn_toggle = function(ap, highlight, connected, others) {
          var ap_btn_hide, ap_btn_show, _ref;
          if (highlight == null) {
            highlight = false;
          }
          if (connected == null) {
          ...
          _ref = highlight ? ['disconnect', 'connect'] : ['connect', 'disconnect'], ap_btn_show = _ref[0], ap_btn_hide = _ref[1];
        ...
        return sb_log("unrecognized ev: " + e.data);
      }
    };
    sock_connect();
